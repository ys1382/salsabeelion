...
- **Tenebris** (owner locked **2026-08-11 night**; restored **2026-08-12 night** after dropped drama pass) — treat the following live answer as the **gold who-is sample**. **Do not change wording or sentence order.** Machine lock: `lorekeeper/tests/fixtures/tenebris_who_is_gold.txt` + `test_who_is_tenebris_gold_locked` — must stay green.
...
**Owner voice target:** Facts must match the **Tenebris gold sample** above. Dramatic / catch-up / book-blurb voice on who-is is **dropped** — do not retry. Restate only what notes + main draft support; never invent.
...
- Do **not** retry dramatic cast-card or catch-up-voice rewrites on who-is

### Plot relation / plot summary accuracy — timing (pinned 2026-08-10; owner opened plot work 2026-08-11)

**Owner note (2026-08-11; voice dropped 2026-08-12 night):** Who-is **accuracy** is the locked Tenebris gold sample above. Dramatic cast-card voice is dropped — do not mix it into a plot pass.
...
- [x] **Gold BASELINE locked (2026-08-12 evening — owner “fine, keep it”)** — Q: *Get me caught up with this story.* Bar for **premise / thin-draft** catch-up (stories like *The Waking Dream*), not a full plotted novel recap. Machine lock: `lorekeeper/tests/fixtures/catchup_waking_dream_gold.txt` + `test_owner_gold_baseline_shape_locked`. **Do not regress** must-keeps: Fall/Author · registration / can’t simply leave · antagonist Capricorn–Silver/Heart framing · **not without a soul / softer side** · **dangerous asset or threat** · Sparrow takes her somewhere + recruitment method · hero may take issue · invent-nothing footer. Self-check + stakes classes stay on. Later answers may deepen; they must not fall below this.
...
**Leave-off / main-draft plot — accuracy milestone (pinned 2026-08-11; gold sample updated same day; fixture locked 2026-09-19):** Owner checked **excellent** for leave-off planning brief. Machine lock: `lorekeeper/tests/fixtures/leave_off_plot_gold.txt` + `test_leave_off_plot_gold_shape_locked`. **Do not** edit that fixture or soften the test without owner OK.
