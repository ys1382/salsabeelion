...
- intent: one of summarize_story, character_portrait, story_resume, who_is, relationship, coverage, audit, narrow_fact
...
- question_kind: one of who, topic, resume, relationship, coverage, fallback

Routing guide:
- summarize_story: plot, scenes, motivation, "what happens", "what would make", story questions needing synthesis
- character_portrait: "what kind of person", personality, traits, portrait of a named character or role
- story_resume: where the story left off, current story state, pick up where I left off
...
pipeline:
- rag_summarize: default for summarize_story, character_portrait, motivation, most story questions
- rag_cast_card: who_is only
- rag_resume: story_resume only

answer_model:
- sonnet: summarize_story, character_portrait, story_resume, relationship, coverage (anything needing synthesis)
- haiku: narrow_fact only
...
_VALID_KINDS = frozenset(
    {"who", "topic", "resume", "relationship", "coverage", "fallback", "knowledge"}
)
