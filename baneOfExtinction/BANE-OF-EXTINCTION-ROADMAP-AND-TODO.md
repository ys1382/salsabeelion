...
- **Crops & Domestic Animals focus (2026-07-23):** renamed from Food history stub. Crops, farm animals, and companions (cats/dogs OK). Claude: domestication eras, plain crop discovery dates (not settler/Indigenous conflict), husbandry noticing. **Claude banned** from human-injustice history (famine politics, colonial oppression, etc.) — that waits for owner-curated real sources. Environmental complications at higher **fact levels**. Pigs: ancestry/litter/husbandry OK; never encourage eating; “pork unhealthy” = later pin.
...
- [ ] Later: owner-curated packs from real sources for left-out human-injustice / famine history (not Claude)
  - **Split:** Claude may do ecological complications (monoculture blight risk, invasive escape, overgrazing). Justice-linked “environment” stories (who was starved, stolen land, forced labor) → curated packs only.
