...
- [x] **Week one after Monday: forest wood before café** (owner — 2026-09-23) — Day 1 stays café. Tuesday–Sunday of week one, the morning job is the forest first. One dead tree (same shape, dead-brown needles) falls to the existing stump after the swing. Logs are held in hand for now — the sack from the home crate is not wired yet. Shipped 2026-09-23.
- [ ] **Mara’s chilly night and the home campfire** (owner — 2026-09-23) — End of day: Mara says it is chilly tonight; at home, build/light a **campfire behind the house**, far from other buildings. Use the pack’s **lit campfire** flicker (not an invented flame); unlit pit first if needed. Keep it outdoor — never indoors. Not this pass.
