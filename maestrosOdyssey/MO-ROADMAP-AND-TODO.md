...
- [ ] **P is pick or place** (owner — 2026-09-24) — **mechanics.** One key, the word depends on where you are. **P — Pick** at a berry bush is in (2026-09-24). **P — Place** waits for the home crate. In the order type box, P is just the letter. It does not walk, talk, or open doors.
...
- [ ] **Home crate as real storage** (owner — 2026-09-23; stacks 2026-09-23; hotbar 2026-09-23) — Minecraft-chest style: open UI, put items in / take out, save with the account/run. The closed crate in the room stays the wooden box. **E** opens a simple panel. The same item **stacks**, and the number on that slot is the real count in storage (logs × 3), not a single picture when you have several. Also a **row of boxes along the bottom of the screen**, like a Minecraft hotbar, showing what you are carrying. Each box is one item, with the real count in that box. No sack picture required for the berries or other items to be in there. Today the crate only shows flavor text on E, and nothing like that bar exists. Not built yet.
