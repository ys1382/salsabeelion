...
- [x] **Have to read the board to order** (shipped 2026-09-25) — you already must tap the menu once. Mara’s order line no longer lists today’s drinks and foods, so the wall is where the items are. She still asks “What’s your order?” and still teaches the day’s shape: **y** on Tuesday, **con** for extras from Wednesday, **un / una** from Thursday. That lesson stays short. Prices stay on the board. The type box and same-reply drink stay.
...
- [x] **Learning card in a slot** (owner — 2026-09-24) — Taking it from the basket puts a **card-shaped** picture in one of the two bottom slots. Same proportions as a credit card, small enough for the slot. **Not** a bank card: no blue, no silver, no chip, no stripe, no real brand. Warm game colors and a simple mark so it reads as this neighborhood’s learning card. Pesos stay the top-left line. One card, no stack count. Shipped 2026-09-24. Storing it is the next bullet.
- [x] **Learning card can be stored** (owner — 2026-09-24) — It is a real object, so **P — Place** can put it in the home crate or the home barrel when it is in slot 1 or slot 2 and you are holding it out. It leaves your hands and the bottom row. **P — Pick** brings it back into a free slot and you are holding it out. While it is stored, it is not on you, and Mara will not take a paid order until you take it back. The pesos stay on it. A later thief can steal it from you or from that container. The thief is not built. Shipped 2026-09-24.
...
- [x] **Riverfolk are light blue** (owner — 2026-09-26) — The Monday riverfolk is a river merfolk, not a crocodile. Their color is a light blue, water and sky together. Ocean merfolk are a deeper, ocean blue. The river person reads lighter than that. The iguana at that table stays the green lizardfolk. Only the riverfolk changes. No ocean merfolk is in the café yet, so the deeper blue stays ready and the lighter blue is on the riverfolk. The face carries the color; the outfit stays the same villager sheet. Lines, the table, and the keys already in use stay. Shipped 2026-09-26.

**From original MO — not in Godot yet**

- [ ] **#13–19 week-one mellow room** — rotating regulars the current sheet can carry, species + language in small beats, not mystery. Monday iguana + river merfolk are **seated at a café table** with ferry talk (2026-09-22). Tuesday werewolf fiancé (male) + sister + female vampire sit as people (2026-09-22); no wolf form. You already have to hear everyone before the food comes (2026-09-22). The door-to-counter walk stays open (2026-09-22). Still open: human table, then Thu–Sun mellow rooms. **No pegasus, griffin, minotaur, or other very detailed creatures until after animation upgrades.** No café TV until then. Keep the favorite-drink / favorite-food / add-on lines.
