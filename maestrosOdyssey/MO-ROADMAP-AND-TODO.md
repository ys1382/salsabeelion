...
- [ ] **Don’t walk through people or things** (owner — 2026-09-22; slip-past 2026-09-23) — bump into NPCs, furniture, counters, crates, and walls. Not a ghost. **People:** you stop on them, then if you keep holding that way you slip past, the way Stardew lets you push through a crowd. A ring of customers must not trap you in the café. **Furniture and walls** stay solid, including a deliberate cluster of obstacles. Do not phase through tables or the counter by holding the key. If furniture seals the only path (door to counter, door out), fix the layout. Mechanics, not an art pass.
...
- [ ] **Blueberry bushes** (owner — 2026-09-23) — **pre-animation-upgrade, before the train station.** No berry shrub in the pack; invent on a real bush (berries drawn on like the cup / stepping stones). Later in the pre-station demo arc, not week-one wood day unless owner says so.
